...
export const DontAccount: string = "Don`t have an account?";
...
export const DragDrop: string = "Drag & drop your file here, or click to select a file";
