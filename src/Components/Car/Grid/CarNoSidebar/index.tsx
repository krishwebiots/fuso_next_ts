...
const CarNoSidebarContainer = () => {
  return (
    <Fragment>
      ...
      <GridView type={"car"} sectionClass='car-shop-section car-product-section' filterclass='filter-sidebar' side='nosidebar' gridSize={3} cardShow={9} tagclass='car-list-header' />
    </Fragment>
  );
};
